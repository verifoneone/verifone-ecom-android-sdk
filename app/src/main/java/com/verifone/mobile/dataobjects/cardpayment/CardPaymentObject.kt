...
class CardPaymentObject {
    constructor(card:String, payment_provider_contract:String, amount_val:Double, auth_type:String, capture_now:Boolean, merchant_reference:String, card_brand:String, currency_code:String, dynamic_descriptor:String, threed_authentication: ThreedsValidationData?, keyAlias:String) {
